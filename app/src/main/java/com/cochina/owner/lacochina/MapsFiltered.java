...
public class MapsFiltered extends FragmentActivity implements LocationListener, OnMapReadyCallback,
...
// Obtain the SupportMapFragment and get notified when the map is ready to be used.
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(MapsFiltered.this,
        ...
        ValueEventListener listener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < arrayRestaurant.size(); i++) {
                    ...
                    if(latitude< mLastLocation.getLatitude()+0.02 && latitude >mLastLocation.getLatitude()-0.02 && longitude < mLastLocation.getLongitude()+0.02 && longitude > mLastLocation.getLongitude()-0.02 ){
...
*/
                    //if(Eventolatitud < latitud+0.02 and Eventolatitud > latitud-0.02 and Eventolongitud < longitud+0.02 and Eventolongitud > longitud-0.02):
    ...
    private void  notifyCannotAccessLocation(){
        Toast.makeText(MapsFiltered.this, "No se pude acceder a su ubicación, conceda permiso a la aplicación", Toast.LENGTH_LONG).show();
    }
